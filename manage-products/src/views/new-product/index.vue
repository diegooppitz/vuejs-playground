<template>
  <div class="product-manager">
    <h1 class="product-title">Adicionar Produto</h1>
...
export default {
  ...
  methods: {
    async submitProduct() {
      ...
      try {
        await axios.post(API_URL, this.product);
        toast.success('Produto adicionado com sucesso!');
        this.product = { name: '', description: '', price: '', company: '' };
      } catch (error) {
        toast.error('Erro ao adicionar o produto: ' + error.message);
      }
    },
  },
};
